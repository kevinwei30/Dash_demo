...
if os.path.isfile(local_data):
    ...
    datafile = 'https://docs.google.com/spreadsheets/d/1u9bHjx6EDX-xM1eKQFkNEi5UPeN_pluvBx8KNYEHYvc/export?format=csv&gid=502958310'
